        ...
        <div className="App flex font-montserrat w-full">
            ...
            <div className="flex flex-col justify-center w-1/2">
                <Routes>
                    ...
                    <Route path="/add-email" element={<AddForm title="Your Email Here" type="email" subtitle="Provide the email you want to associate with your merchant account. We'll send a link there for verification" placeholder="Email" />} />
                    ...
                    <Route path="/business-profile-completion" element={<BusinessProfile />} />
                    ...
                    <Route path="/reset-pass" element={<Login title="Reset Password" type1="password" type2="password" name1="password" name2="confirmPassword" placeholder1="New Password" placeholder2="Confirm Password" btnName="Reset Password" />} />
